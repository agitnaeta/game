    ...
    <div class="col s12">
      <div class="card">
        <div class="card-content">
          <h5><i class="fa fa-edit"></i> Detail Lowongan </h5>
        </div>    
      </div>
      <div class="card">
        <div class="card-content">
          <table>
            <tr>
              ...
              <td><b id="lamaran"><?=yesno($request->lamaran,"Mengajukan","Belum Mengajukan");?></b> </td>  
            </tr>
            <tr>
              <td>Jabatan</td>
            ...
            <tr>
              <td>Tanggal</td>
              <td><?=ucfirst($request->tanggal);?></td>
            </tr>
          </table>  
        </div>
        <div class="card-action">
          <a href="<?=base_url("lamaran");?>" class="btn grey"> << Kembali</a>
          ...
          <?php if(isset($_SESSION['pelamar'])) { ?>
            <a href="#" class="btn orange cancel" data-link="<?=base_url("lamaran/pengajuan/$request->idreq");?>"> 
              <i class="fa fa-upload"></i> Ajulan Lamaran
            </a>
          <?php } ;?>
  ...
  $(document).ready(function () {
    $('.cancel').click(function () {
      swal({
          ...
          text: "Pastikan CV anda lengkap sebelum mengajukan",
          icon: "warning",
          buttons: true,
          dangerMode: true,
        })
