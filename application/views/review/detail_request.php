    ...
    <div class="col s12">
      ...
      <div class="card">
        ...
        <div class="card-action">
          <a href="<?=base_url("review");?>" class="btn grey"> << Kembali</a>
          ...
          <?php } ;?>
          <?php if(isset($_SESSION['management']) or isset($_SESSION['admin']))  { ?>
          <a href="#" title="Tolak Pemintaan" class="btn red cancel" data-link="<?=base_url("request/tolak/$request->idreq");?>"> <i class="fa fa-remove"></i> Tolak</a>
          <a href="#" title="Approve Permintaan Karyawan" class="btn  cancel" data-link="<?=base_url("request/approve/$request->idreq");?>"> <i class="fa fa-check"></i> Approve</a>
            <?php };?>
        </div>    
      </div>
    </div>
